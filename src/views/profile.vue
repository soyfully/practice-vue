    ...
    <div class="container">
        <div class='wrap'>
            <div class='page-explain'>
                ...
                <div class='sub-title'>
                    Javascript, css 를 활용한 모션 그리고 Frameworks 에 관심이 많습니다. <br>
                    또한 자바스크립트 플러그인과 라이브러리의 사용을 필요 외엔 최소화하기 위해<br>
                ...
                <div class="accordion">
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="acc-panel">
                            <div class="datatable-report">
                                <p>
                                    <!-- 구축을 위해 다양한 오픈소스나 레퍼런스 사이트를 볼때면 머리속엔 호기심으로 가득찼습니다. <br>
                                    <br>

                                    아직 저에겐 구현하고 싶은 것들이 많기에 열심히 나아가려 합니다. -->


                                    <!-- 오픈소스나 다양한 웹 사이트를 보면 머리속엔 호기심으로 가득 찼습니다. <br>
                                    그에 대한 답을 얻기 위해 개발자 도구를 열어 스크립트 구조를 살펴보고, <br>
                                    코드를 어떻게 활용했는지 공부하는 등 호기심이 생기면 곧장 해결해야 직성이 풀렸습니다. <br>
                                    또, 기능과 모션 구현에 있어서 더 나은 방법은 없는지, <br>
                                    어떻게 해야 다른 사람들이 쉽게 사용할 수 있도록 디벨롭 할 수 있을지와 같이 <br>
                                    궁금한 것을 따라 공부를 진행하고 있습니다. <br>
                                    이러한 호기심을 놓치지 않고 스크립트의 기본기와 완성도를 보다 더 높혀 나아가겠습니다. -->
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div class="acc-panel">
                            <div class="datatable-report">
                                <p>
                                    열정에 대해선 많은 것이 있지만, 그 중 협업에 대해 말씀드리겠습니다. <br>
                                    <!-- 다양한 사람들과 일하는 직군이기 때문에 협업 및 문제 해결 능력 또한 중요하다고 생각합니다. <br> -->
                                </p>
                            </div>
                        </div>
                    </div>
